...
async function runBackTest() {
  const testDir = "../assets/samples/back";
  ...
  fs.writeFileSync('../results/../results/test_back_results.json', JSON.stringify(allResults, null, 2));
  console.log("Results written to ../results/../results/test_back_results.json");
}
