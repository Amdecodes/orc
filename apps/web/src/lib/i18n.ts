...
export const translations: Record<string, Record<SupportedLanguages, string>> = {
  ...
  fastest_way: { en: 'The fastest way to format your Ethiopian ID for printing', am: 'የኢትዮጵያን መታወቂያ ለህትመት ለማዘጋጀት የቀለለ መንገድ' },
   ...
   disclaimer: { en: 'We do not store any user data. We are not an official partner of id.gov.et or Fayda.', am: 'ማንኛውንም የተጠቃሚ መረጃ አናስቀምጥም። ከ id.gov.et ወይም ከፋይዳ ጋር ይፋዊ አጋርነት የለንም።' },
  ...
  uploading: { en: 'Uploading Screenshots...', am: 'ፎቶዎቹ እየተጫኑ ነው...' },
  generating: { en: 'Generating...', am: 'እየተዘጋጀ ነው...' },
  processing: { en: 'Processing Your ID...', am: 'መታወቂያዎ እየተሰራ ነው...' },
  finalizing: { en: 'Finalizing...', am: 'በመጨረስ ላይ...' },
  wait_time_est: { en: '~{{seconds}}s wait time', am: '~{{seconds}} ሰከንድ መጠበቂያ ጊዜ' },
  ...
  tip_long_press: { en: '💡 Tip:press Download button to save directly to your Phone Gallery', am: '💡 ጠቃሚ ምክር: ምስሉን ስልኮ ላይ ለማስቀመጥ Download button ን ይጫኑ' },
  download_png: { en: 'Download ', am: 'ያውርዱ' },
