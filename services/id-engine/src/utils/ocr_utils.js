/**
 * Sanitizes Amharic text by removing trailing punctuation and collapsing whitespace.
 */
export function sanitizeAmharicText(text) {
  if (!text) return "";
  return text
    .trim()
    // Remove trailing Amharic/Standard punctuation: ፡ ። ፦ : ؛ and variants
    .replace(/[\u1361\u1362\u1363\u1365\u1366\u003A\u061B]+$/, "")
    .replace(/\s+/g, " ")
    .trim();
}
